...
for enc_mode in ENC_MODES:
    ...
    plt.ylim(bottom=0)
    plt.savefig(f'graphs/enc-{enc_mode}-primitives-time-by-key-size.pdf', bbox_inches='tight',
                pad_inches=0)
    plt.close()
    ...
    plt.ylim(bottom=0)
    plt.savefig(f'graphs/enc-{enc_mode}-primitives-speed-by-key-size.pdf', bbox_inches='tight',
                pad_inches=0)
    plt.close()
